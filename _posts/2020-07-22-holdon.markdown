...
<section class="spotlights">
    <section>
		...
		<div class="content">
			<div class="inner">
<p>On a typical London commute, there are quite a few unspoken rules. The first rule is to never speak to anyone on the journey, but no words are necessary: it's basically a co-operative game in which passengers organise themselves around one another in the carriage and coordinate wrapping their palms atop each other up and down the poles, all without words or even eye contact. Very occasionally, there may be a cat wrapping its entire body around the pole, but cats are only small, so everybody else could still hold on and quietly cast their gaze onto their newspaper, their phone, or a tube poster.</p>
    </div></div></section></section><br>
<p>Does the scene depicted resonate with you? Get in touch with your own stories @tubetiquette on Twitter and Instagram! There's also <a href="{% post_url 2020-07-22-scoop %}">this design</a> we've created for the launch, so do check it out too.</p>
